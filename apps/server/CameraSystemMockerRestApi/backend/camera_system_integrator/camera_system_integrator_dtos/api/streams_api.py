...
class StreamsApi:
    ...
    def get_camera_stream(
        ...
        _param = self._get_camera_stream_serialize(
            camera_id=camera_id,
    ...
    @validate_call
    def get_camera_stream_with_http_info(
        self,
        camera_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCameraStream200Response]:
        """Get camera stream descriptor
    ...
    @validate_call
    def get_camera_stream_without_preload_content(
        self,
        camera_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_camera_stream_serialize(
        self,
        camera_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/cameras/{cameraId}/stream',
