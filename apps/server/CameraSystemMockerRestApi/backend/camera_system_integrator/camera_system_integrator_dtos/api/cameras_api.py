...
class CamerasApi:
    ...
    def get_integrator_camera(
        ...
        _param = self._get_integrator_camera_serialize(
            camera_id=camera_id,
    ...
    @validate_call
    def get_integrator_camera_with_http_info(
        self,
        camera_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListIntegratorCameras200ResponseCamerasInner]:
        """Get camera details from the camera system
    ...
    @validate_call
    def get_integrator_camera_without_preload_content(
        self,
        camera_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_integrator_camera_serialize(
        self,
        camera_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/cameras/{cameraId}',
    ...
    def list_integrator_cameras(
        ...
        _param = self._list_integrator_cameras_serialize(
            group_id=group_id,
            search=search,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def list_integrator_cameras_with_http_info(
        self,
        group_id: Optional[StrictStr] = None,
        search: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def list_integrator_cameras_without_preload_content(
        self,
        group_id: Optional[StrictStr] = None,
        search: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _list_integrator_cameras_serialize(
        self,
        group_id,
        search,
        _request_auth,
