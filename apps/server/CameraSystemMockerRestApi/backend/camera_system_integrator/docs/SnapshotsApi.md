...
------------- | ------------- | -------------
[**get_camera_frame_image**](SnapshotsApi.md#get_camera_frame_image) | **GET** /cameras/{cameraId}/frames/{frameId}/image | Get camera frame image bytes
...
> bytearray get_camera_frame_image(camera_id, frame_id)
...
with camera_system_integrator_dtos.ApiClient(configuration) as api_client:
    ...
    try:
        # Get camera frame image bytes
        api_response = api_instance.get_camera_frame_image(camera_id, frame_id)
        print("The response of SnapshotsApi->get_camera_frame_image:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SnapshotsApi->get_camera_frame_image: %s\n" % e)
```
