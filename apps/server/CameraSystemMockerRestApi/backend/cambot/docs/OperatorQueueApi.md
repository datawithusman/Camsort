...
with cambot_dtos.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling OperatorQueueApi->create_operator_queue_item: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **create_operator_queue_item_request** | [**CreateOperatorQueueItemRequest**](CreateOperatorQueueItemRequest.md)|  | 
