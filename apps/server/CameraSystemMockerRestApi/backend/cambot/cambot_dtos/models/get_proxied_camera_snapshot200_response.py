...
class GetProxiedCameraSnapshot200Response(BaseModel):
    """
    ...
    frame: GetProxiedCameraSnapshot200ResponseFrame
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "frame": GetProxiedCameraSnapshot200ResponseFrame.from_dict(obj["frame"]) if obj.get("frame") is not None else None
        })
        return _obj
