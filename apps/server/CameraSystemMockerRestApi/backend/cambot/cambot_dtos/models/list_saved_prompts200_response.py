...
class ListSavedPrompts200Response(BaseModel):
    """
    ListSavedPrompts200Response
    """ # noqa: E501
    prompts: List[ListSavedPrompts200ResponsePromptsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prompts": [ListSavedPrompts200ResponsePromptsInner.from_dict(_item) for _item in obj["prompts"]] if obj.get("prompts") is not None else None
        })
        return _obj
