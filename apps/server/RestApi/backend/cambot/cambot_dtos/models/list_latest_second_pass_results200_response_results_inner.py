...
class ListLatestSecondPassResults200ResponseResultsInner(BaseModel):
    """
    ...
    prompt_score: Union[Annotated[float, Field(le=100, strict=True, ge=0)], Annotated[int, Field(le=100, strict=True, ge=0)]] = Field(alias="promptScore")
    ...
    __properties: ClassVar[List[str]] = ["promptId", "cameraGroupId", "cameraId", "operationId", "secondPassResultId", "firstPassResultId", "frameRefId", "frameUrl", "include", "globalRank", "promptScore", "operatorPriorityScore", "operatorAction", "reason", "updatedAt"]
