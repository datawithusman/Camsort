...
class GetUsageLimitSettings200Response(BaseModel):
    """
    GetUsageLimitSettings200Response
    """ # noqa: E501
    max_scans_per_day: Optional[StrictInt] = Field(default=None, alias="maxScansPerDay")
    max_scans_per_month: Optional[StrictInt] = Field(default=None, alias="maxScansPerMonth")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maxScansPerDay": obj.get("maxScansPerDay"),
