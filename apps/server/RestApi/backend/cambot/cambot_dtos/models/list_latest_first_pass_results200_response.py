...
class ListLatestFirstPassResults200Response(BaseModel):
    """
    ListLatestFirstPassResults200Response
    """ # noqa: E501
    results: List[ListLatestFirstPassResults200ResponseResultsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ListLatestFirstPassResults200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
