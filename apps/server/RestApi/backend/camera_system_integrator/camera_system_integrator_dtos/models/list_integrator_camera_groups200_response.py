...
class ListIntegratorCameraGroups200Response(BaseModel):
    """
    ListIntegratorCameraGroups200Response
    """ # noqa: E501
    groups: List[ListIntegratorCameraGroups200ResponseGroupsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [ListIntegratorCameraGroups200ResponseGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
