...
class ListIntegratorCameras200Response(BaseModel):
    """
    ListIntegratorCameras200Response
    """ # noqa: E501
    cameras: List[ListIntegratorCameras200ResponseCamerasInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cameras": [ListIntegratorCameras200ResponseCamerasInner.from_dict(_item) for _item in obj["cameras"]] if obj.get("cameras") is not None else None
        })
        return _obj
