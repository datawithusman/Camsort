...
json = "{}"
# create an instance of GetCameraSnapshot200ResponseFrame from a JSON string
get_camera_snapshot200_response_frame_instance = GetCameraSnapshot200ResponseFrame.from_json(json)
# print the JSON string representation of the object
print(GetCameraSnapshot200ResponseFrame.to_json())

# convert the object into a dict
get_camera_snapshot200_response_frame_dict = get_camera_snapshot200_response_frame_instance.to_dict()
# create an instance of GetCameraSnapshot200ResponseFrame from a dict
get_camera_snapshot200_response_frame_from_dict = GetCameraSnapshot200ResponseFrame.from_dict(get_camera_snapshot200_response_frame_dict)
```
