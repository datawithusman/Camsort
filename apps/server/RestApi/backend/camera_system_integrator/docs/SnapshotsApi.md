...
------------- | ------------- | -------------
[**get_camera_snapshot**](SnapshotsApi.md#get_camera_snapshot) | **GET** /cameras/{cameraId}/snapshot | Get camera snapshot image


# **get_camera_snapshot**
> bytearray get_camera_snapshot(camera_id)
...
|-------------|-------------|------------------|
**200** | Snapshot image bytes returned |  -  |
**400** | Bad request |  -  |
**401** | Unauthorized |  -  |
