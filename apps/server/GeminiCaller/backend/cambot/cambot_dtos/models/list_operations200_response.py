...
class ListOperations200Response(BaseModel):
    """
    ListOperations200Response
    """ # noqa: E501
    operations: List[ListOperations200ResponseOperationsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "operations": [ListOperations200ResponseOperationsInner.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None
        })
        return _obj
