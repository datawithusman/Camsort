...
class ListOperationFirstPassResults200ResponseResultsInner(BaseModel):
    """
    ...
    include: StrictBool = Field(description="True when the first-pass result should be considered by the second pass.")
    first_pass_prompt_score: Union[Annotated[float, Field(le=100, strict=True, ge=0)], Annotated[int, Field(le=100, strict=True, ge=0)]] = Field(description="Per-snapshot score from the first image pass. This is not the final global prompt score.", alias="firstPassPromptScore")
    ...
    __properties: ClassVar[List[str]] = ["id", "operationId", "cameraId", "cameraGroupId", "promptId", "frameRefId", "frameUrl", "include", "firstPassPromptScore", "operatorPriorityScore", "operatorAction", "reason", "rawModelJson", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firstPassPromptScore": obj.get("firstPassPromptScore"),
