...
class CreateOperation201Response(BaseModel):
    """
    ...
    estimate: Optional[EstimateOperation200Response] = None
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    completed_at: Optional[datetime] = Field(default=None, alias="completedAt")
    __properties: ClassVar[List[str]] = ["id", "operationType", "status", "target", "savedPromptId", "temporaryPromptText", "estimate", "createdAt", "completedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "estimate": EstimateOperation200Response.from_dict(obj["estimate"]) if obj.get("estimate") is not None else None,
