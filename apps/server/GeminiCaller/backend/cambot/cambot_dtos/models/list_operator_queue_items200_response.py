...
class ListOperatorQueueItems200Response(BaseModel):
    """
    ListOperatorQueueItems200Response
    """ # noqa: E501
    items: List[ListOperatorQueueItems200ResponseItemsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ListOperatorQueueItems200ResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
