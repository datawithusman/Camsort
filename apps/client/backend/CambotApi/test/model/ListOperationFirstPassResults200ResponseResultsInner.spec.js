...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CambotApi.ListOperationFirstPassResults200ResponseResultsInner();
  });
  ...
  describe('ListOperationFirstPassResults200ResponseResultsInner', function() {
    it('should create an instance of ListOperationFirstPassResults200ResponseResultsInner', function() {
      // uncomment below and update the code to test ListOperationFirstPassResults200ResponseResultsInner
      //var instance = new CambotApi.ListOperationFirstPassResults200ResponseResultsInner();
      //expect(instance).to.be.a(CambotApi.ListOperationFirstPassResults200ResponseResultsInner);
    });
    ...
    it('should have the property firstPassPromptScore (base name: "firstPassPromptScore")', function() {
      // uncomment below and update the code to test the property firstPassPromptScore
      //var instance = new CambotApi.ListOperationFirstPassResults200ResponseResultsInner();
      //expect(instance).to.be();
    });
