...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CambotApi.ListLatestSecondPassResults200ResponseResultsInner();
  });
  ...
  describe('ListLatestSecondPassResults200ResponseResultsInner', function() {
    it('should create an instance of ListLatestSecondPassResults200ResponseResultsInner', function() {
      // uncomment below and update the code to test ListLatestSecondPassResults200ResponseResultsInner
      //var instance = new CambotApi.ListLatestSecondPassResults200ResponseResultsInner();
      //expect(instance).to.be.a(CambotApi.ListLatestSecondPassResults200ResponseResultsInner);
    });
