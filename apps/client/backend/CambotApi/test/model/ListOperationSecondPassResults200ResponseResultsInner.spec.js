...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CambotApi.ListOperationSecondPassResults200ResponseResultsInner();
  });
  ...
  describe('ListOperationSecondPassResults200ResponseResultsInner', function() {
    it('should create an instance of ListOperationSecondPassResults200ResponseResultsInner', function() {
      // uncomment below and update the code to test ListOperationSecondPassResults200ResponseResultsInner
      //var instance = new CambotApi.ListOperationSecondPassResults200ResponseResultsInner();
      //expect(instance).to.be.a(CambotApi.ListOperationSecondPassResults200ResponseResultsInner);
    });
    ...
    it('should have the property firstPassResultId (base name: "firstPassResultId")', function() {
      // uncomment below and update the code to test the property firstPassResultId
      //var instance = new CambotApi.ListOperationSecondPassResults200ResponseResultsInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property globalRank (base name: "globalRank")', function() {
      // uncomment below and update the code to test the property globalRank
      //var instance = new CambotApi.ListOperationSecondPassResults200ResponseResultsInner();
      //expect(instance).to.be();
    });
