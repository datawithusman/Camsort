...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CambotApi.GetProxiedCameraFrameUrl200Response();
  });
  ...
  describe('GetProxiedCameraFrameUrl200Response', function() {
    it('should create an instance of GetProxiedCameraFrameUrl200Response', function() {
      // uncomment below and update the code to test GetProxiedCameraFrameUrl200Response
      //var instance = new CambotApi.GetProxiedCameraFrameUrl200Response();
      //expect(instance).to.be.a(CambotApi.GetProxiedCameraFrameUrl200Response);
    });
