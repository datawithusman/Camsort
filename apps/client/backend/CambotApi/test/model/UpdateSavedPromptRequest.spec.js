...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CambotApi.UpdateSavedPromptRequest();
  });
  ...
  describe('UpdateSavedPromptRequest', function() {
    it('should create an instance of UpdateSavedPromptRequest', function() {
      // uncomment below and update the code to test UpdateSavedPromptRequest
      //var instance = new CambotApi.UpdateSavedPromptRequest();
      //expect(instance).to.be.a(CambotApi.UpdateSavedPromptRequest);
    });
