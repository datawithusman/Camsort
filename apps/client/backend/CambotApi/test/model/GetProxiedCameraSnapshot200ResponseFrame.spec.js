...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CambotApi.GetProxiedCameraSnapshot200ResponseFrame();
  });
  ...
  describe('GetProxiedCameraSnapshot200ResponseFrame', function() {
    it('should create an instance of GetProxiedCameraSnapshot200ResponseFrame', function() {
      // uncomment below and update the code to test GetProxiedCameraSnapshot200ResponseFrame
      //var instance = new CambotApi.GetProxiedCameraSnapshot200ResponseFrame();
      //expect(instance).to.be.a(CambotApi.GetProxiedCameraSnapshot200ResponseFrame);
    });
