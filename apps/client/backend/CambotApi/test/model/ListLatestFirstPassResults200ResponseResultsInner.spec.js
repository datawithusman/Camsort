...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CambotApi.ListLatestFirstPassResults200ResponseResultsInner();
  });
  ...
  describe('ListLatestFirstPassResults200ResponseResultsInner', function() {
    it('should create an instance of ListLatestFirstPassResults200ResponseResultsInner', function() {
      // uncomment below and update the code to test ListLatestFirstPassResults200ResponseResultsInner
      //var instance = new CambotApi.ListLatestFirstPassResults200ResponseResultsInner();
      //expect(instance).to.be.a(CambotApi.ListLatestFirstPassResults200ResponseResultsInner);
    });
