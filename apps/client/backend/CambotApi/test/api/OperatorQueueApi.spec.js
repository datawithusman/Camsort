...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CambotApi.OperatorQueueApi();
  });
  ...
  describe('OperatorQueueApi', function() {
    ...
    describe('listOperatorQueueItems', function() {
      it('should call listOperatorQueueItems successfully', function(done) {
        ...
        //instance.listOperatorQueueItems(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateOperatorQueueItem', function() {
      it('should call updateOperatorQueueItem successfully', function(done) {
        //uncomment below and update the code to test updateOperatorQueueItem
        //instance.updateOperatorQueueItem(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
