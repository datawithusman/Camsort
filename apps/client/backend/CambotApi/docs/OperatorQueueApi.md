...
let createOperatorQueueItemRequest = new CambotApi.CreateOperatorQueueItemRequest(); // CreateOperatorQueueItemRequest | 
apiInstance.createOperatorQueueItem(createOperatorQueueItemRequest).then((data) => {
...
------------- | ------------- | ------------- | -------------
 **createOperatorQueueItemRequest** | [**CreateOperatorQueueItemRequest**](CreateOperatorQueueItemRequest.md)|  | 
